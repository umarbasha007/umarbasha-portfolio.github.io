...
mhnUI = {
    ...
    lock: function () {
        mhnUI
            .page
            .hide(),
        (pattern = new PatternLock(".mhn-lock", {margin: 15})),
        $(".mhn-lock-title").html($(".mhn-lock-title").data("title")),
        pattern.checkForPattern("1478963", // M - ,"7415369", U - "1478963"
                function () {
            $(".mhn-lock-title").html(
...
!(function (t, e, n, a) {
    ...
    function r(t) {
        for (
            ...
            o.push(
                '<li class="patt-circ" style="margin:' + r + "px; width : " + 2 * i + "px; height : " + 2 * i + "px; -webkit-border-radius: " + i + "px; -moz-border-radius: " + i + "px; b" +
                "order-radius: " + i + 'px; "><div class="patt-dots"></div></li>'
            );
        o.push("</ul>"),
        e
            .html(o.join(""))
    ...
    var l = function () {},
        ...
        d = function (e, a) {
            ...
            var r = p[a.token];
            if (!r.disabled) {
                r.option.patternVisible || r
                    .holder
                    .addClass("patt-hidden");
        ...
        h = function (e, n) {
            ...
            if (u) {
                if (-1 == l.indexOf(c)) {
                    ...
                    var E = t('<div class="patt-lines" style="top:' + (
                        O - 5
                    ) + "px; left:" + (
                        C - 5
                    ) + 'px"></div>');
        ...
        u = function (t, e) {
            ...
            n
                .holder
                .off(".pattern-move")
                .removeClass("patt-hidden"),
            a && (n.option.onDraw(a), n.line.remove(), n.rightPattern && (
                a == n.rightPattern
                    ? n.onSuccess()
                    : (n.onError(), e.error())
            ));
    ...
    (o.prototype = {
        ...
        getIdxFromPoint: function (t, e) {
            var n = this.option,
                ...
                u = i % l;
            return (
                p <= a[1] && d <= a[0] && h > 2 * s && u > 2 * s && (o = (d - 1) * a[1] + p),
                {
                    idx: o,
                    i: p,
                    j: d,
    ...
    (s.prototype = {
        ...
        option: function (t, e) {
            ...
            return e === a
                ? i[t]
                : ((i[t] = e), void(("margin" == t || "matrix" == t || "radius" == t) && r(n)));
        },
        getPattern: function () {
            return p[this.token]
                .patternAry
        ...
        reset: function () {
            ...
            t
                .pattCircle
                .removeClass("hovered dir s n w e s-w s-e n-w n-e"),
            t
                .holder
                .find(".patt-lines")
                .remove(),
            ...
            t
                .holder
                .removeClass("patt-error patt-success");
        },
        error: function () {
            p[this.token]
                .holder
